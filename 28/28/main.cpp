...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pGround->LoadMesh("D:/1/dev2/project/Content/quad.obj")) {
            return false;
        }
                       
        m_pTexture = new Texture(GL_TEXTURE_2D, "D:/1/dev2/project/Content/bricks.jpg");
        ...
        m_pNormalMap = new Texture(GL_TEXTURE_2D, "D:/1/dev2/project/Content/normal_map.jpg");
